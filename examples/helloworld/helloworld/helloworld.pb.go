...
type MvmError struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Not used when in grpc error details; extract error message from the grpc error
	Msg         string `protobuf:"bytes,1,opt,name=msg,proto3" json:"msg,omitempty"`
	LibmvmError uint32 `protobuf:"varint,2,opt,name=libmvm_error,json=libmvmError,proto3" json:"libmvm_error,omitempty"`
}

func (x *MvmError) Reset() {
	*x = MvmError{}
	if protoimpl.UnsafeEnabled {
...
func (x *MvmError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MvmError) ProtoMessage() {}

func (x *MvmError) ProtoReflect() protoreflect.Message {
	mi := &file_helloworld_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MvmError.ProtoReflect.Descriptor instead.
func (*MvmError) Descriptor() ([]byte, []int) {
	return file_helloworld_proto_rawDescGZIP(), []int{2}
}

func (x *MvmError) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
func (x *MvmError) GetLibmvmError() uint32 {
	if x != nil {
		return x.LibmvmError
	}
	return 0
}
...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x3f, 0x0a, 0x08, 0x4d, 0x76,
	0x6d, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x12, 0x21, 0x0a, 0x0c, 0x6c, 0x69, 0x62, 0x6d,
	0x76, 0x6d, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b,
	0x6c, 0x69, 0x62, 0x6d, 0x76, 0x6d, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x32, 0x49, 0x0a, 0x07, 0x47,
...
var file_helloworld_proto_goTypes = []interface{}{
	...
	(*MvmError)(nil),     // 2: helloworld.MvmError
}
